...
if(isset($_SESSION['user'])){
    ?>
    <script type="text/javascript">window.location='<?=base_url()?>'</script>
    <?php
}else{
?>
<!DOCTYPE html>
                    ...
                    { ?>
                        <div class="row">
                            <div class="col-lg-6 col-lg-offset-3">
                                <div class="alert alert-danger alert_dismissable" role="alert">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times</a>
                                    <span class="glyphicon glyphicon-exclamation-sign" aria-sign="true"></span>
