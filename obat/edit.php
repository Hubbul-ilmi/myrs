        ...
        <div class="col-lg-6 col-lg-offset-3">
            ...
            <form action="proses.php" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_obat" value="<?=$data['nama_obat']?>" class="form-control" id="nama" required autofocus>
                </div>
                <div class="form-group">
                    <label for="ket">Keterangan</label>
                    <textarea name="ket" class="form-control" id="ket" required><?=$data['ket_obat']?></textarea>
                </div>
