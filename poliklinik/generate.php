	...
	<div class="box">
		...
		<h4>
			...
			<div class="pull-right">
				<a href="data.php" class="btn btn-default btn-flat btn-xs"><i class="glyphicon glyphicon-chevron-left"></i>  Kembali</a>
			</div>
		</h4>
			...
			<div class="col-lg-6 col-lg-offset-3">
				<form action="add.php" method="post">
					...
					<div class="form-group pull-right">
						<input type="submit" name="generate" value="Generate" class="btn btn-flat btn-success">
					</div>
				</form>
			</div>
		</div>
